...
printf '%s\n' \
  ...
  'Planner starts on Terra; complex or elevated drafts are automatically refined once by Sol before discussion or implementation. Trivial Reviewers use a compact verification prompt. These policies are Codex-only.' \
  '' \
