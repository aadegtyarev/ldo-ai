...
grep -q -- '--continue-plan latest' "$TARGET/AGENTS.md"
grep -q 'always print a concise operator report in normal prose' "$TARGET/AGENTS.md"
grep -q 'Never silently finish without the operator report' "$TARGET/AGENTS.md"
