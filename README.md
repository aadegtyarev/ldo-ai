...
scripts/check-*.sh           # Fourteen gates over LDO's own source — schema size, model
│                             # table, verdict gates, scoped tests, env status,
│                             # record/backlog, contracts, redaction,
│                             # check-artifact-reconciliation.sh, check-isolation.sh,
│                             # version-lockstep, plan-signals, design-drift, and
│                             # cost accounting; see Contributing
