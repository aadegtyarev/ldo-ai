...
scripts/check-*.sh           # Gates over LDO's own source — schema size, model table,
│                             # verdict gates, scoped tests; see Contributing
